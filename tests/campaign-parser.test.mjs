...
const parse = buildCampaignParser({
  ...
  programs: [
    ...
    { slug: 'wvi', match_pattern: '(^|[^a-z])wvi([^a-z]|$)|de-?anon|deano|website.?visitor|rb2b|vector|koala|warmly', sort_order: 30 },
...
const CASES = [
  ...
  ['Dheeraj-WVI-08/09', { sdr: 'Dheeraj', program: 'wvi', theme: 'WVI' }],
  ['Dheeraj-WVI-1', { sdr: 'Dheeraj', program: 'wvi', theme: 'WVI' }],
  ['Akhil_Koala_OSS_(after announcement)_20250717', { sdr: 'Akhil', program: 'wvi', theme: 'WVI' }],
